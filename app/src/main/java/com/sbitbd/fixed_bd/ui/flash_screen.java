        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            switch (motionEvent.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    if (AUTO_HIDE) {
                        delayedHide(AUTO_HIDE_DELAY_MILLIS,0);
                    }
                    break;
...
//                | View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION);
    ...
    private void delayedHide(int delayMillis, int closeDelay) {
        ...
        if (isOnline() && closeDelay != 0){
            ...
            MaterialAlertDialogBuilder dialogBuilder = new MaterialAlertDialogBuilder(flash_screen.this);
            ...
            dialogBuilder.setNeutralButton("Setting",(dialog, which) -> {
